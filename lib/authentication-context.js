...
AuthenticationContext.prototype.acquireTokenWithUsernamePassword = function(resource, username, password, clientId, clientSecret, callback)  {
  ...
  this._acquireToken(callback, function() {
    var redirectUri = null; // We don't need a redirectUri for acquireTokenWithUsernamePassword
    var tokenRequest = new TokenRequest(this._callContext, this, clientId, resource, redirectUri, clientSecret);
